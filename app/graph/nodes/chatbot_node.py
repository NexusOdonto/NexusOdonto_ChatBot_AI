...
SYSTEM_MESSAGE = SystemMessage(
    content=(
        ...
        "TRAS AGENDAR O CONFIRMAR CITA CON ÉXITO: en el mensaje final al paciente "
        "INCLUYE SIEMPRE un recordatorio breve de que puede consultar su cita en la "
        "plataforma virtual / portal del paciente, con la URL "
        "https://nexusodonto.chatcampuslands.com/login. No omitas la URL ni el recordatorio.\n\n"
